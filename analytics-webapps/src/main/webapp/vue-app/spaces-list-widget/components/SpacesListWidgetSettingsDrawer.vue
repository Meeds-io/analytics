  ...
  <exo-drawer
    ...
    <template v-if="drawer" #content>
      <div class="d-flex align-center pa-5">
        <div>{{ $t('analytics.spacesListWidgetSettings.spacesMemberOf') }}</div>
        <v-switch
      ...
      <div class="d-flex align-center px-5">
        <div class="font-weight-bold">{{ $t('analytics.spacesListWidget.userSpaces') }}</div>
        <number-input
      ...
      <div class="d-flex align-center px-5">
        <div class="font-weight-bold">{{ $t('analytics.spacesListWidgetSettings.recentlyVisited') }}</div>
        <number-input
      ...
      <div class="d-flex align-center px-5">
        <div class="font-weight-bold">{{ $t('analytics.spacesListWidgetSettings.mostActive') }}</div>
        <number-input
