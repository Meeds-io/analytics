...
<template>
  <div>
    ...
    <label
      ...
      class="text-header ignore-vuetify-classes me-1 my-4"
    ...
    <template v-if="yAxisAggregationGroupBy">
      <label class="text-header ignore-vuetify-classes me-1 my-4" :for="`analyticsYAxisThresholdInput${uid}`">{{ $t('analytics.threshold') }}</label>
      <div class="width-auto flex-grow-1 mt-1 mb-4">
        <v-text-field
