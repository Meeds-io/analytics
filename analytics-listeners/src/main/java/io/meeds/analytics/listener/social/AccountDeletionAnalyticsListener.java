 ...
 * request of their own account together with its deletion (event source =
 * username, data = social identity id), so that platform administrators can
 * follow the deletion requests in reports.
 */
@Asynchronous
@Component
public class AccountDeletionAnalyticsListener extends Listener<String, String> {

  public static final String OPERATION = "accountDeletionRequest";
